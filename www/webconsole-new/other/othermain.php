...
function othermain()
{
    if (checkaccess('other', 'read'))
    {
        ...
        //echo '<a href="./index.php?do=listtraits">List traits</a> <br/>'; commented pending a decision on what to do with this since there is no more such table, but the information is still out there.
