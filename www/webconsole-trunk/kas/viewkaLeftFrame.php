...
<title>View Knowledge Area</title>
...
<?PHP
	...
	echo "foldersTree = gFld(\"<b>KA: $area</b>\", \"index.php?page=npc_actions&operation=viewka&type=ka&area=$area\");\n"; 
	// start printing the triggers from triggers with prior=0
	printChildTriggers("foldersTree", $area, 0, 2, 1, "ka");
...
<div valign='bottom'><p><A HREF='index.php?page=listkas' target='_top'>Back to KAs Index </A></p></div>
</body>
